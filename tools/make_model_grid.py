...
deploy_common_root = os.path.join("/", "home", "d", "ds", "ds283", "LSSEFT-haloeft_2018_01_Apollo")
...
deploy_model_root = os.path.join("/", "home", "d", "ds", "ds283", "LSSEFT-haloeft_2018_01_Apollo", "models")
