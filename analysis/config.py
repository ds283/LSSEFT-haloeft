...
def make_config_block(realization, fit_kmin=0.02, fit_kmax=0.30, ren_kmin=0.02, ren_kmax=0.30):
    ...
    my_config["HaloEFT", "theory_db"] = os.path.join(root, "theory/WizCOLA_CAMB_halo_full@z=0_kWiggleZ.sqlite")
